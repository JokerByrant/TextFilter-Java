...
public class IntDictionary2 {
    ...
    public IntDictionary2(Map<Integer, Integer> dict) {
    ...
    public static IntDictionary2 Load(CSharpDataInputStream dis) throws IOException {
        int len = dis.reverseReadInt();
        if (len == 0) {
            return new IntDictionary2(new int[0], new int[0]);
        }
        int[] keys = dis.readIntArray();
